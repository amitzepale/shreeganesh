...
<body>
<form action="<%=request.getContextPath()%>/sandowservlet" method="post">
<section>
	...
	<div class="main">
			...
			<label>Product Description</label>
				<textarea placeholder="Product Size Availables Product Colours Availables" rows="5" cols="50" name="product_description"></textarea>
